...
<script type="text/javascript">
	$(function(){
		...
		$("#prevPage").click(function() {
			...
			window.location.href = "/babyassistant/listBabiesInClass?curPage="+curPage+"&pageSize="+pageSize;
		});
	...
	<div>
		...
		<div class="content">
			...
			<ul class="nav nav-pills" role="tablist">
	  			<li><a href="/babyassistant/listBabyEnrollInfo">待分班</a></li>
	  			<li class="active"><a href="/babyassistant/listBabiesInClass">已分班</a></li>
			</ul>
			<table class="table table-bordered table-hover" style="font-size:40px" id="classAttendance">
				...
				<tbody>
					<c:forEach items="${pv.datas}" var="hasDivideInfo">
						<tr>
							<td>${hasDivideInfo.baby_no}</td>
							<td>${hasDivideInfo.baby_name}</td>
							<td>${hasDivideInfo.real_name}</td>
							<td>${hasDivideInfo.pay_status}</td>
							<td style="text-align:center">
								<a href="/babyassistant/updateClassInfoOfBaby?babyId=${hasDivideInfo.baby_id}"><input type="button" class="btn btn-info" value="移出班级" style="font-size:35px;"></a>
							</td>
						 </tr>
					</c:forEach>
					<tr>
