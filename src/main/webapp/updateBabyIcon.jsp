...
<script type="text/javascript">
	$(function(){
		...
		$(".coverSave").click(function(){
			...
			formData.append("iconPath", $("#babyImg")[0].files[0]);
			$.ajax({
				url:"${pageContext.request.contextPath }/updateBabyIcon",
				type:"post",
				dataType:"text",
				data:formData,
...
<body>
	<div>
		...
		<div class="container" style="font-size:30px;margin-top:40%;margin-left:20%;">
			<form action="updateBabyIcon" id="iconForm">
				<div class="col-xs-12">
					<input type="file" id="babyImg" name="babyImg">
					<input type="text" id="iconPath" name="iconPath" hidden="hidden">
				</div>
				<div class="col-xs-12" id="babyIcon">
					<img src="" id="bImg" name="bImg" style="width:400px;height:400px;border:solid rgb(30,30,30) 0px;">
				</div>
			</form>
		</div>
	</div>
